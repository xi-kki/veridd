...
export const VeriddBadge: React.FC<VeriddBadgeProps> = ({ score, totalReviews, size = 'md' }) => {
  ...
  if (totalReviews === 0) {
    return (
      <div className="flex flex-col items-center gap-1.5 group">
        <div className={`${sizes[size]} rounded-full bg-gray-800 border-2 border-gray-700 
  ...
  return (
    <div className="flex flex-col items-center gap-1.5 group">
      {/* Score Circle */}
      <div className={`${sizes[size]} rounded-full bg-gradient-to-br ${tier.color} ${tier.shadow} 
